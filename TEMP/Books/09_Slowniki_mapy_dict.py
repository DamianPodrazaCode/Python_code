...
d['jeden'] = '1' # dodanie pary elementów, pary są dowolne typowo w przypadku klucza jak i wartości
d[2.0] = 'dwa'
d['text'] = 1 +23j
d[1.23] = 2.34
print(d)
...
print(d)
# albo
dd = dict(text=12, asd=32.23, dfg='asd')  # tylko ta kluczem jest zawsze string
print(dd)
