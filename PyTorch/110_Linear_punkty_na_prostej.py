...
plt.scatter(x=X_test.cpu(), y=test_pred.cpu(), c='y', s=4,  label="Test")
plt.legend()
...
plt.scatter(x=X_train.cpu(), y=y_pred.cpu().detach().numpy(), c='r', s=4,  label="Uczenie")
plt.scatter(x=X_test.cpu(), y=test_pred.cpu().detach().numpy(), c='y', s=4,  label="Test")
plt.legend()
